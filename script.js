...
const DECISION_SIGNALS = [
  {
    ...
    tags: ["frontend", "architecture", "reasoning", "debugging", "writing"],
  },
  {
    title: "Project context size",
    type: "frontend_fullstack",
    outcome: "Large repos benefit from scoped planning before high-leverage execution.",
    tags: ["fullstack", "tests", "deployment", "backend", "data"],
  },
  {
  ...
  },
  {
    ...
    outcome: "The easiest tool can be the best route when handoffs would slow the team down.",
    tags: ["research", "writing", "strategy", "tests"],
  },
];
